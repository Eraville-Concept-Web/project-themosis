<?php
	...
	if (!function_exists('generate_sanitize_empty_absint')) {
		/**
	...
	if (!function_exists('generate_sanitize_variants')) {
		/**
	...
	if (!function_exists('generate_do_control_inline_scripts')) {
		/**
		...
		function generate_do_control_inline_scripts()
		{
			...
			wp_localize_script(
				...
				array(
					'googleFonts' => apply_filters(
						'generate_typography_customize_list',
						generate_get_all_google_fonts($number_of_fonts)
					),
				)
			);
			...
			wp_enqueue_script(
				...
				) . 'inc/customizer/controls/js/customizer-controls.js',
			...
			wp_localize_script(
				'generatepress-customizer-controls',
				'generatepress_typography_defaults',
	...
	if (!function_exists('generate_customizer_live_preview')) {
		...
		function generate_customizer_live_preview()
		{
			...
			wp_enqueue_script(
				...
				trailingslashit(
					get_template_directory_uri()
				) . 'inc/customizer/controls/js/customizer-live-preview.js',
	...
	if (!function_exists('generate_has_custom_logo_callback')) {
		/**
	...
	if (!function_exists('generate_sanitize_preset_layout')) {
		/**
	...
	if (!function_exists('generate_is_using_floats_callback')) {
		/**
	...
	if (!function_exists('generate_show_inline_logo_callback')) {
		/**
